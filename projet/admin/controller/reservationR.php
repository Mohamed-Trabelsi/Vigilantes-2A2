<?php
 ...
 public function filtre_DateR() {
        ...
        public function deleteReservation($id) {
            ...
            public function getStatisticHotel()
            {
                $sql = "select hotels.name as name , count(*) as nbr from reservations inner join hotels on hotels.id = reservations.hotel GROUP BY reservations.hotel";
                $db = getConnexion();
                $req = $db->prepare($sql);
                try {
                    $req->execute();
