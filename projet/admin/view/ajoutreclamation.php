                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <h5 align="left"><?php  echo 'User ID : ',$_SESSION['a'] ?></h5>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" name="sujet" id="sujet" placeholder="sujet">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <input type="reset" value="Annuler" class="btn btn-primary"
                                       style="float: left; height: 55px; padding: 0px 0px;">
                                     <!--  <a type="button" class="btn btn-primary" href = "reclamationuser.php">annuler</a>-->
                        </div>
