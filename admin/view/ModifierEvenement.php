    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="services.html" class="nav-link">Adoption</a></li>
                <li class="nav-item"><a href="gallery.html" class="nav-link">Gallery</a></li>
                <li class="nav-item"><a href="pricing.html" class="nav-link">Pricing</a></li>
                <li class="nav-item active"><a href="blog.html" class="nav-link">Engagements Sociaux</a></li>
...
$data = $query->fetchAll();
?>
<label class="label" for="nom">Nom de group:</label>
<select  name="id_group" id="id_group" value = "<?= $result['id_group'] ?>">
...
<?php endforeach ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="label" for="nom">Nom d'evenement:</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="label" for="dateD">Date Debut:</label>
                                <input required type="datetime-local" class="form-control" name="dateD" id="dateD" placeholder="date debut" value = "<?= $result['dateD'] ?>">
                            </div>
                        </div>

                           <div class="col-md-6">
                            <div class="form-group">
                                <label class="label" for="nb_participant">Nombre de participants:</label>
                                <input required  type="text" class="form-control" name="nb_participant" id="nb_participant" placeholder="Nombre de participants" value = "<?= $result['nb_participant'] ?>">
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="label" for="contact">Date Fin:</label>
                                <input required type="datetime-local" class="form-control" name="dateF" id="dateF" placeholder="date fin" value = "<?= $result['dateF'] ?>">
                            </div>
                        </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required  type="text" class="form-control" name="adresse" id="adresse" placeholder="adresse location" value = "<?= $result['adresse'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="file" accept="image/png, image/jpeg" class="form-control" name="image"
                                       id="image" value = "<?= $result['image'] ?>">
                            </div>
                        </div>
                    

                        <div class="col-md-12" >
                         <input onclick="EnvoyerE()"  value="Modifier" class="btn btn-primary"
...
<script src="controlesaisieE.js"></script>
</body>
</html>