                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" name="num" id="num" placeholder="Numero telephone">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" name="contact" id="contact" placeholder="example@xyz.com">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea required name="description" class="form-control" id="description" rows="5"
                                          placeholder="Description de votre group ..."></textarea>
                            </div>
                        </div>
          <!--***************ena badalt type submit b onclick="Envoyer() **********-->
                        <div class="col-md-12" >
                         <input onclick="EnvoyerG()"  value="Ajouter" class="btn btn-primary"
