    ...
    <div class="row">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-signin my-5">
                <div class="card-body">
                    <h5 class="card-title text-center">Nouveau Hotel</h5>
		<div class="form-container">
            <form action="" method = "POST" class="form-signin">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="number" name = "prix" class="form-control" required autofocus>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input type = "adresse" name = "adresse" class="form-control" required>
                    </div>
                    <div class="col-25">
                        <label>chambres disponibles<span style="color: #FF0000">*</span></label>
                    </div>
                    <div class="col-75">
                        <input type = "number" name = "chambre" class="form-control" required>
                    </div>
                    <div class="col-25">
                        <label>caracteristique<span style="color: #FF0000">*</span></label>
                    </div>
                    <div class="col-75">
                        <textarea name="caracteristiques"  class="form-control"></textarea>
                    <div class="col-25">
                ...
                <br>
                <div class="row">
                    <input type="submit" value="ajouter" name = "submit" class="btn btn-lg btn-primary btn-block text-uppercase">
                </div>
            </form>
		</div>
        </div>
