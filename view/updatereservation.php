...
<meta charset="UTF-8">
      ...
      <title>modification des reservations</title>
        ...
        <div class="form-container">
                            <form action="" method = "POST">
                                <div class="row">
                                    ...
                                    <div class="col-75">
                                        <input type="date" name = "dateR" value = "<?= $result['dateR'] ?>" required class="form-control" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-25">
                                    ...
                                    <div class="col-75">
                                        <input type="date" name = "check_in" value = "<?= $result['check_in'] ?>" required class="form-control" required>
                                    </div>
                                    <div class="row">
                                    <div class="col-25">
                                    ...
                                    <div class="col-75">
                                        <input type="date" name = "check_out" value = "<?= $result['check_out'] ?>" required class="form-control" required>
                                    </div>
                                    <div class="row">
                                    <div class="col-25">
                                    ...
                                    <div class="col-75">
                                        <input type="number" name = "paiement" value = "<?= $result['paiement'] ?>" required class="form-control" required>
                                    </div>
                                    <div class="row">
                                    <div class="col-25">
                                        <label>hotel</label>
                                    ...
                                    <div class="col-75">
                                        <input type="number" name = "hotel" value = "<?= $result['hotel'] ?>" required class="form-control" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-25">
                                    ...
                                    <div class="col-75">
                                        <input type = "number" name = "client" value = "<?= $result['client'] ?>" required class="form-control" required>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <input type="submit" value="modifier" name = "submit" class="btn btn-lg btn-success btn-block" required

                                    >
                                </div>
                                   <a href = "mail.php" class="btn btn-lg btn-success btn-block"class="btn btn-lg btn-success btn-block">send mail
