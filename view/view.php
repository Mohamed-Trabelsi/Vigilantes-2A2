...
<div class="form-group">
  ...
  <div class="col-md-4"> 
    <a href="admin.php"><input type="button" class="sub" value="pour admin" class="btn btn-primary" ></a>
  </div>
</div>
   </fieldset>
</form>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="occupation" name="occupation" placeholder="Enter your occupation" class="form-control input-md" type="text">
