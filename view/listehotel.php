    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="ajouterAnimal.php" class="nav-link">Adoption</a></li>
                <li class="nav-item"><a href="gallery.html" class="nav-link">Gallery</a></li>
                <li class="nav-item"><a href="pricing.html" class="nav-link">Pricing</a></li>
                <li class="nav-item"><a href="blog.html" class="nav-link">Blog</a></li>
                <li class="nav-item"><a href="afficompte.php" class="nav-link">Compte</a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="container">
        ...
        <div class="row">
            <?php foreach ($hotels as $hotel) { ?>
             <a href="addreservation.php?id=<?= $hotel['id'] ?>"><div class="col-md-6 col-lg-4 ftco-animate fadeInUp ftco-animated">
                <div class="staff">
                    ...
                    <div class="text pt-3 px-3 pb-4 text-center">
                        ...
                        <span class="position mb-2"><?php echo $hotel['prix']; ?></span>
                        <div class="faded">
                            <p><?php echo $hotel['adresse']; ?></p>
                            <p><?php echo $hotel['caracteristiques']; ?></p>
                        </div>
                    </div>
                </div>
            </div>
