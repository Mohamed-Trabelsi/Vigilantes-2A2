...
<?php endforeach ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="datetime-local" class="form-control" name="dateD" id="dateD" placeholder="date debut">
                            </div>
                        </div>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required  type="text" class="form-control" name="nb_participant" id="nb_participant" placeholder="Nombre de participants">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required type="datetime-local" class="form-control" name="dateF" id="dateF" placeholder="date fin">
                            </div>
                        </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required  type="text" class="form-control" name="adresse" id="adresse" placeholder="adresse location">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12" >
                         <input onclick="EnvoyerE()"  value="Ajouter" class="btn btn-primary"
